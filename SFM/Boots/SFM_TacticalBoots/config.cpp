class CfgPatches
{
	class SFM_TacticalBoots
	{
		units[]=
		{
			"SFM_TacticalBoots_Base",
			"SFM_TacticalBoots_1",
			"SFM_TacticalBoots_Bandit1"
		};
		weapons[]={};
		requiredVersion=0.1;
		requiredAddons[]=
...
class CfgVehicles
{
	...
	{
		scope=2;
		displayName="$STR_CfgVehicles_SFM_TacticalBoots_Base0";
		descriptionShort="$STR_CfgVehicles_SFM_TacticalBoots_Base1";
	...
	class SFM_TacticalBoots_1: SFM_TacticalBoots_Base
	{
		scope=2;
	...
	class SFM_TacticalBoots_Bandit1: SFM_TacticalBoots_Base
	{
		scope=2;
		visibilityModifier=0.94999999;
		hiddenSelectionsTextures[]=
