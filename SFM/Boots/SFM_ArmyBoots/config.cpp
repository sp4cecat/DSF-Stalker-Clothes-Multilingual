...
class CfgVehicles
{
	...
	{
		scope=0;
		displayName="$STR_CfgVehicles_SFM_ArmyBoots_ColorBase0";
		descriptionShort="$STR_CfgVehicles_SFM_ArmyBoots_ColorBase1";
	...
	class SFM_ArmyBoots_Black: SFM_ArmyBoots_ColorBase
	{
		scope=2;
	...
	class SFM_ArmyBoots_Green: SFM_ArmyBoots_ColorBase
	{
		scope=2;
		visibilityModifier=0.80000001;
		hiddenSelectionsTextures[]=
	...
	class SFM_ArmyBoots_Tan: SFM_ArmyBoots_ColorBase
	{
		scope=2;
		visibilityModifier=0.80000001;
		hiddenSelectionsTextures[]=
	...
	class SFM_ArmyBoots_UCP: SFM_ArmyBoots_ColorBase
	{
		scope=2;
		visibilityModifier=0.80000001;
		hiddenSelectionsTextures[]=
	...
	class SFM_ArmyBoots_Woods: SFM_ArmyBoots_ColorBase
	{
		scope=2;
		visibilityModifier=0.80000001;
		hiddenSelectionsTextures[]=
		{
			"\SFM\Boots\SFM_ArmyBoots\data\Boots_Woods_BaseColor.paa"
		};
	};
};
