class CfgPatches
{
	class SFM_ZephyrBoots
	{
		units[]=
		{
			"SFM_ZephyrBoots_Desert",
			"SFM_ZephyrBoots_Black",
			"SFM_ZephyrBoots_mil"
		};
		weapons[]={};
		requiredVersion=0.1;
...
class CfgVehicles
{
	...
	{
		scope=0;
		displayName="$STR_CfgVehicles_SFM_ZephyrBoots_Base0";
		descriptionShort="$STR_CfgVehicles_SFM_ZephyrBoots_Base1";
	...
	class SFM_ZephyrBoots_Desert: SFM_ZephyrBoots_Base
	{
		scope=2;
	...
	class SFM_ZephyrBoots_Black: SFM_ZephyrBoots_Base
	{
		scope=2;
		visibilityModifier=0.80000001;
		hiddenSelectionsTextures[]=
	...
	class SFM_ZephyrBoots_mil: SFM_ZephyrBoots_Base
	{
		scope=2;
		visibilityModifier=0.80000001;
		hiddenSelectionsTextures[]=
