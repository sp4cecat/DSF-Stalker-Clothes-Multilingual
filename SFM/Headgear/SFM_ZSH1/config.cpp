class CfgPatches
{
	class SFM_ZSH1
	{
		units[]=
		{
			"SFM_ZSH1_Helmet_Green",
			"SFM_ZSH1_Helmet_Black"
		};
		weapons[]={};
		requiredVersion=0.1;
		requiredAddons[]=
...
class CfgVehicles
{
	...
	{
		scope=0;
		displayName="$STR_CfgVehicles_SFM_ZSH1_Helmet_Base0";
		descriptionShort="$STR_CfgVehicles_SFM_ZSH1_Helmet_Base1";
	...
	class SFM_ZSH1_Helmet_Green: SFM_ZSH1_Helmet_Base
	{
		scope=2;
		hiddenSelectionsTextures[]=
		{
	...
	class SFM_ZSH1_Helmet_Black: SFM_ZSH1_Helmet_Base
	{
		scope=2;
		hiddenSelectionsTextures[]=
		{
