...
class CfgVehicles
{
	...
	{
		scope=0;
		displayName="$STR_CfgVehicles_SFM_Headphone_Base0";
		descriptionShort="$STR_CfgVehicles_SFM_Headphone_Base1";
	...
	class SFM_Headphone_BLACK: SFM_Headphone_Base
	{
		scope=2;
	...
	class SFM_Headphone_Green: SFM_Headphone_Base
	{
		scope=2;
		visibilityModifier=0.69999999;
		hiddenSelectionsTextures[]=
	...
	class SFM_Headphone_Tan: SFM_Headphone_Base
	{
		scope=2;
		visibilityModifier=0.69999999;
		hiddenSelectionsTextures[]=
