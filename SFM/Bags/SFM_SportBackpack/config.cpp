...
class CfgVehicles
{
	...
	{
		scope=0;
		displayName="$STR_CfgVehicles_SFM_SportBackpack_Base0";
		descriptionShort="$STR_CfgVehicles_SFM_SportBackpack_Base1";
	...
	class SFM_SportBackpack: SFM_SportBackpack_Base
	{
		scope=2;
	...
	class SFM_SportBackpack_Bandit: SFM_SportBackpack_Base
	{
		scope=2;
		visibilityModifier=0.94999999;
		hiddenSelectionsTextures[]=
