...
class CfgVehicles
{
	...
	{
		scope=0;
		displayName="$STR_CfgVehicles_SFM_Sweater_ColorBase0";
		descriptionShort="$STR_CfgVehicles_SFM_Sweater_ColorBase1";
	...
	class SFM_Sweater_Green: SFM_Sweater_ColorBase
	{
		scope=2;
	...
	class SFM_Sweater_Green2: SFM_Sweater_ColorBase
	{
		scope=2;
		visibilityModifier=0.89999998;
		hiddenSelectionsTextures[]=
	...
	class SFM_Sweater_Black: SFM_Sweater_ColorBase
	{
		scope=2;
		visibilityModifier=0.89999998;
		hiddenSelectionsTextures[]=
	...
	class SFM_Sweater_Brown: SFM_Sweater_ColorBase
	{
		scope=2;
		visibilityModifier=0.89999998;
		hiddenSelectionsTextures[]=
	...
	class SFM_Sweater_Merc: SFM_Sweater_ColorBase
	{
		scope=2;
		visibilityModifier=0.89999998;
		hiddenSelectionsTextures[]=
