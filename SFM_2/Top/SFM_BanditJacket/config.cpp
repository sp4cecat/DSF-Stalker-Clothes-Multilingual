...
class CfgVehicles
{
	...
	{
		scope=0;
		displayName="$STR_CfgVehicles_SFM_BanditJacket1_Base0";
		descriptionShort="$STR_CfgVehicles_SFM_BanditJacket1_Base1";
	...
	class SFM_BanditJacket1_Grey: SFM_BanditJacket1_Base
	{
		scope=2;
	...
	class SFM_BanditJacket1_Black: SFM_BanditJacket1_Base
	{
		scope=2;
		visibilityModifier=0.75;
		hiddenSelectionsTextures[]=
	...
	class SFM_BanditJacket1_White: SFM_BanditJacket1_Base
	{
		scope=2;
		visibilityModifier=0.75;
		hiddenSelectionsTextures[]=
	...
	class SFM_BanditJacket2_Base: GorkaEJacket_ColorBase
	{
		scope=0;
		displayName="$STR_CfgVehicles_SFM_BanditJacket1_Base0";
		descriptionShort="$STR_CfgVehicles_SFM_BanditJacket2_Base1";
	...
	class SFM_BanditJacket2_Grey: SFM_BanditJacket2_Base
	{
		scope=2;
		visibilityModifier=0.75;
		hiddenSelectionsTextures[]=
	...
	class SFM_BanditJacket2_Black: SFM_BanditJacket2_Base
	{
		scope=2;
		visibilityModifier=0.75;
		hiddenSelectionsTextures[]=
	...
	class SFM_BanditJacket2_White: SFM_BanditJacket2_Base
	{
		scope=2;
		visibilityModifier=0.75;
		hiddenSelectionsTextures[]=
